...
#define SESSION_SCHEMA            "org.sagarmatha.desktop.session"
#define KEY_IDLE_DELAY            "idle-delay"
#define KEY_SESSION_NAME          "session-name"

#define CSM_MANAGER_SCHEMA        "org.sagarmatha.SessionManager"
...
#define SCREENSAVER_SCHEMA        "org.sagarmatha.desktop.screensaver"
#define KEY_SLEEP_LOCK            "lock-enabled"

#define LOCKDOWN_SCHEMA           "org.sagarmatha.desktop.lockdown"
            ...
            CsmManager *manager)
{
        ...
        if (manager->priv->phase < CSM_MANAGER_PHASE_APPLICATION) {
                 ...
                 * so sagarmatha-session assumes process exit means "ok
...
manager_perhaps_lock (CsmManager *manager)
{
        ...
        error = NULL;
        ret = g_spawn_command_line_sync ("sagarmatha-screensaver-command --lock", NULL, NULL, NULL, &error);
        if (!ret) {
